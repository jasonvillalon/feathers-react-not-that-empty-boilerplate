...
if (babelrcObject.plugins !== undefined) {
  combinedPlugins = combinedPlugins.concat(babelrcObject.plugins);
}

const babelLoaderQuery = Object.assign({}, babelrcObject, babelrcObjectDevelopment, { plugins: combinedPlugins });
delete babelLoaderQuery.env;

babelLoaderQuery.presets = babelLoaderQuery.presets.map(v => v === 'es2015' ? ['es2015', { modules: false }] : v);
